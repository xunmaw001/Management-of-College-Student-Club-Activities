    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="社团分类" prop="shetuanfenlei">
          <el-select :disabled="ro.shetuanfenlei" v-model="ruleForm.shetuanfenlei" placeholder="请选择社团分类">
            <el-option
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="社团简介" prop="shetuanjianjie">
                <el-input
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.shetuanjianjie" label="社团简介" prop="shetuanjianjie">
                    <span>{{ruleForm.shetuanjianjie}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
