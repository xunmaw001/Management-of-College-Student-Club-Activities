<template>
  <div class="addEdit-block">
    ...
    >
      <el-row >
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="成员编号" prop="chengyuanbianhao">
          <el-input v-model="ruleForm.chengyuanbianhao" 
              placeholder="成员编号" clearable  :readonly="ro.chengyuanbianhao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="成员编号" prop="chengyuanbianhao">
              <el-input v-model="ruleForm.chengyuanbianhao" 
                placeholder="成员编号" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
