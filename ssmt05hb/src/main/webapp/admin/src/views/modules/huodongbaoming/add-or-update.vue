    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="报名内容" prop="baomingneirong">
                <editor 
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.baomingneirong" label="报名内容" prop="baomingneirong">
                    <span v-html="ruleForm.baomingneirong"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
	...
	this.ruleForm.baomingneirong = this.ruleForm.baomingneirong.replace(reg,'../../../ssmt05hb/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
